...
|------|--------|--------|-----|---|---|---|---|---|---|---|--------------------|-----------|
| 0 | em andamento (passo 1) — esqueleto e teste de contrato adiantados; faltam baseline, decisão de host, política DataImpulse e evidências | 14/09/2026 | — | ☐ | ☐ | ☐ | ☐ | ☐ | ☐ | ☐ | — | `6175e5b` (esqueleto) |
| 1 | não iniciada | — | — | ☐ | ☐ | ☐ | ☐ | ☐ | ☐ | ☐ | — | — |
| 2 | não iniciada | — | — | ☐ | ☐ | ☐ | ☐ | ☐ | ☐ | ☐ | — | — |
| 3 | não iniciada | — | — | ☐ | ☐ | ☐ | ☐ | ☐ | ☐ | ☐ | — | — |
| 4 | não iniciada | — | — | ☐ | ☐ | ☐ | ☐ | ☐ | ☐ | ☐ | — | — |
